...
class Config:
    ...
    def __init__(self):
        ...
        self.pytest_html_report_path = Config.path_dir + '/PytestReport/'
        ...
        self.tester_yes = self.get_conf(Config.TITLE_YES, Config.VALUE_TESTER)
        self.environment_yes = self.get_conf(Config.TITLE_YES, Config.VALUE_ENVIRONMENT)
        # self.versionCode_debug = self.get_conf(Config.TITLE_YES, Config.VALUE_VERSION_CODE)
        self.host_yes = self.get_conf(Config.TITLE_YES, Config.VALUE_HOST)
        # self.loginHost_debug = self.get_conf(Config.TITLE_YES, Config.VALUE_LOGIN_HOST)
        # self.loginInfo_debug = self.get_conf(Config.TITLE_YES, Config.VALUE_LOGIN_INFO)
