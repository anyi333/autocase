...
requests.packages.urllib3.disable_warnings() #移除警告-InsecureRequestWarning: Unverified HTTPS request is being made. Adding certificate verification is strongly advised
...
​
        ...
        try:
            if data is None:
                ...
                #print('url222222222222',requests.get(url=url, params=data, headers=header,verify=False).url)
...
​
        ...
        try:
            if data is None:
                ...
                #print(requests.post(url=url, data=json.dumps(data), headers=header).url)
    ...
    def post_request_multipart(self, url, data, header, file_parm, file, f_type):
        ...
        try:
            if data is None:
                ...
                response = requests.post(url=url, params=data, headers=header, cookies=self.get_session, verify=False)
...
​
    ...
    def get_yes_request(self, url, data, header):
        """
        Get请求
        :param url:
        :param data:
...
​
        ...
        try:
            if data is None:
                ...
                #print('url222222222222',requests.get(url=url, params=data, headers=header).url)
